...
<html lang="en">
	<head>
		...
		<title>Daftar Pembelian | <?php echo $title; ?></title>
                              ...
                              <table id="button_datatables_example" class="table display table-striped table-bordered">
								 ...
								 foreach($order as $a){ ?>
                                    <tr>
										<td><?php echo $x++; ?></td>
										<td><?php echo $a->id; ?></td>
                                       <td style="text-transform: lowercase;"><?php echo $a->email; ?></td>
                                       <td><b><?php echo $a->status_order; ?></b></td>
                                       <td><b><?php echo $a->status_pembayaran; ?></b></td>
                                       <td><?php echo $a->tanggal_order; ?></td>
                                       <td>
									   <a href="#" onClick="window.open('<?php echo site_url()."index/invoice_pembelian/".$a->id; ?>','Invoice','resizable=0,height=619,width=806'); return false;">Invoice</a><noscript>You need Javascript to use the previous link or use <a href="<?php echo site_url()."index/invoice_pembelian/".$a->id; ?>" target="_blank">Invoice</a></noscript>
									   </td>
                                    </tr>
                                 <?php } ?>

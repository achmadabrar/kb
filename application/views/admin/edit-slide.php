                           ...
                           <div class="row">
                              <div class="col-md-9">
                                 <div class="create-page-left">
                                     <?php echo form_open_multipart('admin/update_slide', array(
    'enctype' => 'multipart/form-data'
)); ?>
					<form method="POST" autocomplete="off" id="nameform" enctype="multipart/form-data">
                                       <p>
                                          <label>Title Slide</label>
                                          <input type="text" placeholder="Masukan Title Slide" name="title" value="<?php echo $slider[0]->title; ?>" required>
                                          <input type="hidden" placeholder="Masukan Title Slide" name="id" value="<?php echo $slider[0]->id; ?>" required>
                                       </p>
									    <p>
                                          <label>Nama Button *kosongkan jika tidak perlu</label>
                                          <input type="text" placeholder="Masukan Nama Button" name="nama_button"value="<?php echo $slider[0]->nama_button; ?>" >
                                       </p>
									   <p>
                                          <label>Link Button *kosongkan jika tidak perlu</label>
                                          <input type="text" placeholder="Masukan Link Button" name="link_button"value="<?php echo $slider[0]->link_button; ?>" >
                                       </p>
                                       
									   <div class="row">
                                          <div class="col-md-6">
                                             <p>
                                               <label>Foto (Featured Image)</label>
                                                 <div class="product-upload btn btn-info">
                                             <i class="fa fa-upload"></i>
                                             Upload Image (minimal ukuran 1920x800px)
									   ...
									   <br>
                                       <p>
										   <input type="submit" value="perbarui slide" class="btn btn-warning" style="color:white;">
                                                <a href="<?php echo site_url(); ?>admin/daftar_slider" class="btn btn-danger" >

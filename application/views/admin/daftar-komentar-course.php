                              ...
                              <table id="button_datatables_example" class="table display table-striped table-bordered">
								 ...
								 foreach($komentar as $a){ ?>
                                    <tr>
                                       ...
                                       <td>
									   <a href="<?php echo site_url()."admin/hapus_komentar_course/".$a->id; ?>" class="btn btn-danger btn-rounded">Hapus</a>

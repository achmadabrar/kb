                     ...
                     <div class="col-md-12">
                        <div class="page-box">
						 <div class="datatables-example-heading">
                               <a href="<?php echo site_url()."admin/tambah_blog/";?>" class="btn btn-warning btn-rounded">Tambah Blog</a>
                           </div>
                              ...
                              <table id="button_datatables_example" class="table display table-striped table-bordered">
								 ...
								 foreach($blog as $a){ ?>
                                    <tr>
                                       ...
                                       <td>
									   <a href="<?php echo site_url()."admin/edit_blog/".$a->id; ?>" class="btn btn-warning btn-rounded">Edit</a>
									   <a href="<?php echo site_url()."admin/hapus_blog/".$a->id; ?>" class="btn btn-danger btn-rounded">Hapus</a>

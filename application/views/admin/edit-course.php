                           ...
                           <div class="row">
                              <div class="col-md-9">
                                 <div class="create-page-left">
                                     <?php echo form_open_multipart('admin/update_course', array(
    'enctype' => 'multipart/form-data'
)); ?>
					<form method="POST" autocomplete="off" id="nameform" enctype="multipart/form-data">
                                       <p>
                                          <label>Judul Course</label>
                                          <input type="text" placeholder="Masukan Judul Course" name="title" value="<?php echo $course[0]->title; ?>" required>
                                       </p>
									    <div class="row">
                                          <div class="col-md-6">
                                             <p>
												...
												?>
												<option value="<?php echo $k->id; ?>" <?php if($k->id==$course[0]->id_kategori){echo "selected";} ?>><?php echo $k->nama; ?></option>
												<?php
												}
												?>
                                                </select>
                                       ...
                                       <div class="page-editor-box">
                                          ...
                                          <textarea id="page-editor" name="deskripsi" class="note-codable" required><?php echo $course[0]->description; ?></textarea>
                                       </div>
									   <div class="row">
                                          <div class="col-md-6">
                                             <p>
                                             ...
                                             Upload Image Minimal Ukuran (Width 870px - Height 472px)
                                             <input type="file" name="foto" >
                                             <input type="hidden" name="id" value="<?php echo $course[0]->id; ?>" required>
                                          </div>
                                             </p>
                                          </div>
									   ...
									   <br>
									    <div class="page-editor-box">
                                          ...
                                          <input type="text" placeholder="Masukan Harga (tanpa titik)" name="harga" value="<?php echo $course[0]->harga; ?>" required>
                                       </div>
									  
									   <br>
									    <div class="page-editor-box">
                                          <label>Durasi Course (/jam, tanpa spasi, tanpa jam)</label>
                                          <input type="text" placeholder="Masukan Durasi Contoh:2" name="durasi" value="<?php echo $course[0]->durasi; ?>" required>
                                       </div>
									   ...
									   <div class="row">
                                          <div class="col-md-6">
                                             <p>
                                                <label>Course Populer</label>
                                                <select class="selectpicker-product select-pro" name="populer" >
												<option value="1" <?php if($course[0]->populer==1){echo "selected";} ?>>Ya</option>
												<option value="0" <?php if($course[0]->populer==0){echo "selected";} ?>>Tidak</option>
                                                </select>
                                             </p>
                                          </div>
									   ...
									   <br>
                                       <p>
										   <input type="submit" value="perbarui course" class="btn btn-warning" style="color:white;">
                                                <a href="<?php echo site_url(); ?>admin/daftar_course" class="btn btn-danger" >

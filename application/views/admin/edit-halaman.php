                           ...
                           <div class="row">
                              <div class="col-md-9">
                                 <div class="create-page-left">
                                     <?php echo form_open_multipart('admin/update_halaman', array(
    'enctype' => 'multipart/form-data'
)); ?>
					<form method="POST" autocomplete="off" id="nameform" enctype="multipart/form-data">
                                       <p>
                                          <label>Judul Halaman</label>
                                          <input type="text" placeholder="Masukan Judul Halaman" name="title" value="<?php echo $halaman[0]->title; ?>" required>
                                       </p>
                                       <div class="page-editor-box">
                                          <label>Konten Halaman</label>
                                          <textarea id="page-editor" name="konten" class="note-codable" required><?php echo $halaman[0]->content; ?></textarea>
                                       </div>
                                       <p>
										   <input type="submit" value="Simpan halaman" class="btn btn-warning" style="color:white;">
                                                <a href="<?php echo site_url(); ?>admin/daftar_halaman" class="btn btn-danger" >
                                 ...
                                 <div class="create-page-right">
                                       <div class="page-img-upload">
                                          ...
                                          <div class="product-upload btn btn-info">
                                             ...
                                             <input type="hidden" name="id" value="<?php echo $halaman[0]->id; ?>" required>
                                          </div>
                                       </div>
                                 </div>
                              </div>

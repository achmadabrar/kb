                           ...
                           <div class="row">
                              <div class="col-md-9">
                                 <div class="create-page-left">
                                     <?php echo form_open_multipart('admin/insert_halaman', array(
    'enctype' => 'multipart/form-data'
)); ?>
					<form method="POST" autocomplete="off" id="nameform" enctype="multipart/form-data">
                                       <p>
                                          <label>Judul Halaman</label>
                                          <input type="text" placeholder="Masukan Judul Halaman" name="title" required>
                                       </p>
                                       ...
                                       <p>
										   <input type="submit" value="tambahkan halaman" class="btn btn-warning" style="color:white;">

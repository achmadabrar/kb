                           ...
                           <div class="row">
                              <div class="col-md-6 col-sm-6">
                                 <div class="add-product-form-group">
                                    ...
                                    <?php echo form_open_multipart('admin/insert_kategori_course', array(
										  ...
										  <br>
                                             <p>
                                               <input type="submit" value="tambahkan" class="btn btn-warning" style="color:white;">
                                                <a href="<?php echo site_url(); ?>admin/daftar_kategori_course" class="btn btn-danger" >

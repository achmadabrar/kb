                           ...
                           <div class="row">
                              <div class="col-md-9">
                                 <div class="create-page-left">
                                     <?php echo form_open_multipart('admin/insert_section', array(
    'enctype' => 'multipart/form-data'
)); ?>
					<form method="POST" autocomplete="off" id="nameform" enctype="multipart/form-data">
                                       <p>
                                          <label>Title Section</label>
                                          <input type="text" placeholder="Masukan Judul Section" name="title" required>
                                       </p>
									    
									    <div class="page-editor-box">
                                          <label>Konten</label>
                                          <textarea id="page-editor" name="konten" class="note-codable" required></textarea>
                                       </div>
									  
									    <div class="page-editor-box">
                                          <label>Video</label>
                                          <input type="text" placeholder="Masukan URL VIDEO YOUTUBE " name="video">
                                       ...
                                       <p>
										   <input type="submit" value="tambahkan course" class="btn btn-warning" style="color:white;">
                                                <a href="<?php echo site_url(); ?>admin/daftar_section/<?php echo $course_id; ?>" class="btn btn-danger" >

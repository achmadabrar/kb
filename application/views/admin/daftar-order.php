                     ...
                     <div class="col-md-12">
                        <div class="page-box">
						 <div class="datatables-example-heading">
                               <a href="https://account.midtrans.com/login" class="btn btn-warning btn-rounded" target="_blank">Login Ke Midtrans</a>
                           </div>
                              ...
                              <table id="button_datatables_example" class="table display table-striped table-bordered">
								 ...
								 foreach($order as $a){ ?>
                                    <tr>
                                       ...
                                       <td>
									   <a href="<?php echo site_url()."admin/detail_order/".$a->id; ?>" class="btn btn-warning btn-rounded">Detail Order</a>

                           ...
                           <div class="row">
                              <div class="col-md-6 col-sm-6">
                                 <div class="add-product-form-group">
                                    <h3>Kategori Course</h3>
                                    <?php echo form_open_multipart('admin/insert_kategori_product', array(
										  ...
										  <br>
                                             <p>
                                               <input type="submit" value="tambahkan" class="btn btn-warning" style="color:white;">
                                                <a href="<?php echo site_url(); ?>admin/daftar_kategori_product" class="btn btn-danger" >

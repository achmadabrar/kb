                           ...
                           <div class="row">
                              <div class="col-md-9">
                                 <div class="create-page-left">
                                     <?php echo form_open_multipart('admin/insert_slide', array(
    'enctype' => 'multipart/form-data'
)); ?>
					<form method="POST" autocomplete="off" id="nameform" enctype="multipart/form-data">
                                       <p>
                                          <label>Title Slide</label>
                                          <input type="text" placeholder="Masukan Title Slide" name="title" required>
                                       </p>
									    <p>
                                          <label>Nama Button *kosongkan jika tidak perlu</label>
                                          <input type="text" placeholder="Masukan Nama Button" name="nama_button">
                                       </p>
									   <p>
                                          <label>Link Button *kosongkan jika tidak perlu</label>
                                          <input type="text" placeholder="Masukan Link Button" name="link_button">
                                       </p>
									   ...
									   <br>
                                       <p>
										   <input type="submit" value="tambahkan slide" class="btn btn-warning" style="color:white;">

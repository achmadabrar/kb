                     ...
                     <div class="col-md-12">
                        <div class="page-box">
						 <div class="datatables-example-heading">
                               <a href="<?php echo site_url()."admin/tambah_section/".$course_id;?>" class="btn btn-warning btn-rounded">Tambah Section</a>
                           </div>
                            <div class="table-responsive advance-table">
                              <table id="button_datatables_example" class="table display table-striped table-bordered">
								 ...
								 foreach($section as $a){ ?>
                                    <tr>
										<td><?php echo $x++; ?></td>
										<td><?php echo $a->id_course; ?></td>
										<td><?php echo $a->title; ?></td>
                                       <td>
									   <a href="<?php echo site_url()."admin/edit_section/".$a->id; ?>" class="btn btn-warning btn-rounded">Edit</a>
									   <a href="<?php echo site_url()."admin/hapus_section/".$a->id."/".$course_id; ?>" class="btn btn-danger btn-rounded">Hapus</a>
									   </td>
                                    </tr>
                                 <?php } ?>

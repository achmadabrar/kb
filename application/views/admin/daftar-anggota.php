                     ...
                     <div class="col-md-12">
                        <div class="page-box">
						 <div class="datatables-example-heading">
                               <a href="<?php echo site_url()."admin/tambah_anggota/";?>" class="btn btn-warning btn-rounded">Tambah Anggota</a>
                           </div>
                              ...
                              <table id="button_datatables_example" class="table display table-striped table-bordered">
								 ...
								 <?php foreach($anggota as $a){ ?>
                                    <tr>
                                       ...
                                       <td><?php echo $a->nomor_handphone; ?></td>
                                       <td><?php if($a->akses==9){echo "Super Admin";}else if($a->akses==8){echo "Admin";}else{ echo "Pengguna";} ?></td>
                                       <td>
									   <a href="<?php echo site_url()."admin/edit_anggota/".$a->id; ?>" class="btn btn-warning btn-rounded">Edit</a>
									   <a href="<?php echo site_url()."admin/hapus_anggota/".$a->id; ?>" class="btn btn-danger btn-rounded">Hapus</a>

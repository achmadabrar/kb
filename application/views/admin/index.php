...
<html lang="en">
   ...
   <body>
                        ...
                        <div id="widget_user" class="widget_card alert">
                           <div class="widget_card_body">
                              ...
                              <div class="widget_text">
                                 <h3 class="count"><?php echo $total_user; ?></h3>
                                 <p>Total Anggota</p>
                              </div>
                           </div>
                        </div>
                     ...
                     <div class="col-md-3">
                        <div id="widget_profits" class="widget_card alert">
                           <div class="widget_card_body">
                              ...
                              <div class="widget_text">
                                 <h3><span class="count"><?php echo $total_produk; ?></span></h3>
                                 <p>Total Produk</p>
                              </div>
                           </div>
                        </div>
					 ...
					 <div class="col-md-3">
                        <div id="widget_profits" class="widget_card alert">
                           <div class="widget_card_body">
                              ...
                              <div class="widget_text">
                                 <h3><span class="count"><?php echo $total_course; ?></span></h3>
                                 <p>Total Courses</p>
                              </div>
                           </div>
                        </div>
      ...
      <!-- Dashboard JS -->
      <script src="<?php echo site_url(); ?>/assetsbackend/js/dashboard.js"></script>
      <!-- Custom JS -->

                           ...
                           <div class="row">
                              <div class="col-md-6 col-sm-6">
                                 <div class="add-product-form-group">
                                    <h3>General</h3>
                                    <?php echo form_open_multipart('admin/update_konfigurasi', array(
    'enctype' => 'multipart/form-data'
					...
					<form method="POST" autocomplete="off" id="nameform" enctype="multipart/form-data">
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                <label>Title / Judul Sistem</label>
                                                <input type="text" placeholder="Nama Anda" value="<?php echo $title; ?>" name="title" required>
                                             </p>
                                          </div>
                                       </div>
									   <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input type="text" placeholder="Deskripsi" value="<?php echo $deskripsi; ?>" name="deskripsi" required>
                                             </p>
                                          </div>
                                       </div>
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                <label>Email</label>
                                                <input type="email" placeholder="Email Sistem" value="<?php echo $email; ?>" name="email" required>
                                             </p>
                                          </div>
                                       </div>
									   <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                <label>Alamat</label>
                                                <input type="text" placeholder="Alamat" value="<?php echo $alamat; ?>" name="alamat" required>
                                             </p>
                                          </div>
                                       </div>
									   <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input type="text" placeholder="No.Telepon" value="<?php echo $telepon; ?>" name="telepon" required>
                                             </p>
                                          </div>
                                       </div>
									   <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input type="text" placeholder="Alamat Facebook" value="<?php echo $facebook; ?>" name="facebook" required>
                                             </p>
                                          </div>
                                       </div>
									   <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input type="text" placeholder="Alamat Twitter" value="<?php echo $twitter; ?>" name="twitter" required>
                                             </p>
                                          </div>
                                       </div>
									   <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input type="text" placeholder="Alamat Instagram" value="<?php echo $instagram; ?>" name="instagram" required>
                                             </p>
                                          </div>
                                       </div>
                                       ...
                                       <div class="row">
                                          <div class="col-md-12">
                                             <div class="product-upload-image">
                                                <img src="<?php echo site_url(); ?>upload/images/<?php echo $logo; ?>" alt="image" width="150px" height="150px"/>
                                             </div>
                                          </div>
                                       </div>
                                       <div class="row">
                                          ...
                                          <div class="col-md-12">
                                             <p>
                                               <input type="submit" value="simpan" class="btn btn-warning" style="color:white;">
                                                <a href="<?php echo site_url(); ?>admin" class="btn btn-danger" >

                           ...
                           <div class="row">
                              <div class="col-md-6 col-sm-6">
                                 <div class="add-product-form-group">
                                    ...
                                    <?php echo form_open_multipart('admin/insert_anggota', array(
									   ...
									   <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input type="text" placeholder="No.Handphone" name="nomor_handphone" required>
                                             </p>
                                          </div>
                                       </div>
                                       <div class="row">
                                 ...
                                 <div class="add-product-image-upload">
                                    <h3>Foto Anggota</h3>
									   ...
									   <div class="row">
										  ...
										  <br>
                                             <p>
                                               <input type="submit" value="tambahkan" class="btn btn-warning" style="color:white;">

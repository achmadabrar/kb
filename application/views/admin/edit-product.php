                           ...
                           <div class="row">
                              <div class="col-md-9">
                                 <div class="create-page-left">
                                     <?php echo form_open_multipart('admin/update_product', array(
    'enctype' => 'multipart/form-data'
)); ?>
					<form method="POST" autocomplete="off" id="nameform" enctype="multipart/form-data">
                                       <p>
                                          <label>Nama Produk</label>
                                          <input type="text" placeholder="Masukan Nama Produk" name="title" value="<?php echo $product[0]->title; ?>" maxlength="25" required>
                                       </p>
									    <div class="row">
                                          <div class="col-md-6">
                                             <p>
												...
												?>
												<option value="<?php echo $k->id; ?>" <?php if($k->id==$product[0]->id_kategori){echo "selected";} ?>><?php echo $k->nama; ?></option>
												<?php
												}
												?>
                                                </select>
                                       ...
                                       <div class="page-editor-box">
                                          ...
                                          <input type="text" placeholder="Masukan Deskripsi" name="deskripsi" maxlength="150" value="<?php echo $product[0]->description; ?>" required>
                                       </div>
									   <br>
                                       <div class="page-editor-box">
                                          <label>Deskripsi Tambahan</label>
                                          <textarea id="page-editor" name="deskripsi_tambahan" class="note-codable" required><?php echo $product[0]->additional_description; ?></textarea>
                                       </div>
									   <div class="row">
                                          <div class="col-md-6">
                                             <p>
                                             ...
                                             <?php echo $product[0]->gambar; ?> Upload Image Minimal Ukuran (Width 470px - Height 417px)
                                             <input type="file" name="foto" >
                                             <input type="hidden" name="id" value="<?php echo $product[0]->id; ?>" accept="image/*" required>
                                          </div>
                                             </p>
                                          </div>
                                          ...
                                          <div class="col-md-6">
                                             <p>
                                               <label>Foto Produk 2</label>
                                                 <div class="product-upload btn btn-info">
                                             <i class="fa fa-upload"></i>
                                             <?php echo $product[0]->gambar2; ?> Upload Image Minimal Ukuran (Width 470px - Height 417px)
                                          ...
                                          <div class="col-md-6">
                                             <p>
                                               <label>Foto Produk 3</label>
                                                 <div class="product-upload btn btn-info">
                                             <i class="fa fa-upload"></i>
                                             <?php echo $product[0]->gambar3; ?> Upload Image Minimal Ukuran (Width 470px - Height 417px)
									   ...
									   <br>
									    <div class="page-editor-box">
                                          ...
                                          <input type="text" placeholder="Masukan Harga (tanpa titik)" name="harga" value="<?php echo $product[0]->harga; ?>" required>
                                       </div>
									   <br>
									    <div class="page-editor-box">
                                          <label>Berat (gram)</label>
                                          <input type="text" placeholder="Masukan Berat (dalam Gram) contoh : 900" name="berat" value="<?php echo $product[0]->berat; ?>" required>
                                       </div>
									   ...
									   <div class="row">
                                          <div class="col-md-6">
                                             <p>
												...
												<option value="tersedia" <?php if($product[0]->stock=='tersedia'){echo "selected";} ?>>Tersedia</option>
												<option value="tidak-tersedia" <?php if($product[0]->stock=='tidak-tersedia'){echo "selected";} ?>>Tidak Tersedia</option>
                                                </select>
                                             </p>
                                          </div>
									   ...
									   <div class="row">
                                          <div class="col-md-6">
                                             <p>
												...
												<option value="1" <?php if($product[0]->populer==1){echo "selected";} ?>>Ya</option>
												<option value="0" <?php if($product[0]->populer==0){echo "selected";} ?>>Tidak</option>
                                                </select>
                                             </p>
                                          </div>
									   ...
									   <br>
                                       <p>
										   <input type="submit" value="perbarui produk" class="btn btn-warning" style="color:white;">
                                                <a href="<?php echo site_url(); ?>admin/daftar_product" class="btn btn-danger" >

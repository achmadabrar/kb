                           ...
                           <div class="row">
                              <div class="col-md-6 col-sm-6">
                                 <div class="add-product-form-group">
                                    <h3>Profil Anda</h3>
                                    <?php echo form_open_multipart('admin/update_anggota', array(
                                       ...
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input type="text" placeholder="Nama Anda" value="<?php echo $anggota[0]->nama_lengkap; ?>" name="nama_lengkap" required>
                                             </p>
                                          </div>
                                       </div>
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                <label>Email</label>
                                                <input type="email" placeholder="Email" value="<?php echo $anggota[0]->email; ?>" name="email" required>
                                             </p>
                                          </div>
                                       </div>
									   <div class="row">
									   ...
									   <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                ...
                                                <input type="text" placeholder="No.Handphone" value="<?php echo $anggota[0]->nomor_handphone; ?>" name="nomor_handphone" required>
                                             </p>
                                          </div>
                                       </div>
                                       <div class="row">
                                          <div class="col-md-12">
                                             <p>
                                                <label>Akses</label>
                                                <select class="selectpicker-product select-pro" name="akses" >
                                                   <option value="1" <?php if($anggota[0]->akses==1){echo "selected";} ?>>Pengguna</option>
                                                   <option value="8" <?php if($anggota[0]->akses==8){echo "selected";} ?>>Admin</option>
                                                   <option value="9" <?php if($anggota[0]->akses==9){echo "selected";} ?>>Super Admin</option>
                                                </select>
                                             </p>
                                          </div>
                                       </div>
                                       ...
                                       <div class="row">
                                          <div class="col-md-12">
                                             <div class="product-upload-image">
                                                <img src="<?php echo site_url(); ?>upload/images/<?php echo $anggota[0]->foto; ?>" alt="image" width="150px" height="150px"/>
                                             </div>
                                          </div>
                                       </div>
                                       <div class="row">
                                             ...
                                             <div class="product-upload-action">
                                                <div class="product-upload btn btn-info">
                                                   <p>
                                                      ...
                                                      Pilih Foto 150x150px
                                                   </p>
                                                   <input type="file" name="foto">
                                                   <input type="hidden" name="id" value="<?php echo $anggota[0]->id; ?>">
                                                </div>
                                          ...
                                          <div class="col-md-12">
                                             <p>
                                               <input type="submit" value="simpan" class="btn btn-warning" style="color:white;">
                                                <a href="<?php echo site_url(); ?>admin/daftar_anggota" class="btn btn-danger" >

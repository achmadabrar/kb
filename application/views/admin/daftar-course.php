                     ...
                     <div class="col-md-12">
                        <div class="page-box">
						 <div class="datatables-example-heading">
                               <a href="<?php echo site_url()."admin/tambah_course/";?>" class="btn btn-warning btn-rounded">Tambah Course</a>
                           </div>
                              ...
                              <table id="button_datatables_example" class="table display table-striped table-bordered">
								 ...
								 foreach($course as $a){ ?>
                                    <tr>
                                       ...
                                       <td style="text-transform: lowercase;"><?php echo $a->author; ?></td>
                                       <td>
									   <a href="<?php echo site_url()."admin/daftar_section/".$a->id; ?>" class="btn btn-info btn-rounded">Lihat Section</a>
									   <a href="<?php echo site_url()."admin/edit_course/".$a->id; ?>" class="btn btn-warning btn-rounded">Edit</a>
									   <a href="<?php echo site_url()."admin/hapus_course/".$a->id; ?>" class="btn btn-danger btn-rounded">Hapus</a>

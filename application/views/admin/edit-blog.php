                           ...
                           <div class="row">
                              <div class="col-md-9">
                                 <div class="create-page-left">
                                     <?php echo form_open_multipart('admin/update_blog', array(
    'enctype' => 'multipart/form-data'
)); ?>
					<form method="POST" autocomplete="off" id="nameform" enctype="multipart/form-data">
                                       <p>
                                          <label>Judul Blog</label>
                                          <input type="text" placeholder="Masukan Judul Halaman" name="title" value="<?php echo $blog[0]->title; ?>" required>
                                       </p>
									    <div class="row">
                                          <div class="col-md-6">
                                             <p>
												...
												?>
												<option value="<?php echo $k->id; ?>" <?php if($k->id==$blog[0]->id_kategori){echo "selected";} ?>><?php echo $k->nama; ?></option>
												<?php
												}
												?>
                                                </select>
                                       ...
                                       <div class="page-editor-box">
                                          ...
                                          <textarea id="page-editor" name="konten" class="note-codable" required><?php echo $blog[0]->content; ?></textarea>
                                       </div>
									   <div class="row">
                                          <div class="col-md-6">
                                             <p>
                                             ...
                                             <input type="hidden" name="id" value="<?php echo $blog[0]->id; ?>" required>
                                          </div>
                                             </p>
                                          </div>
									   ...
									   <br>
                                       <p>
										   <input type="submit" value="perbarui blog" class="btn btn-warning" style="color:white;">
                                                <a href="<?php echo site_url(); ?>admin/daftar_blog" class="btn btn-danger" >

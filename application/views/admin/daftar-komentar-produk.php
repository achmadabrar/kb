                            ...
                            <div class="table-responsive advance-table">
                              <table id="button_datatables_example" class="table display table-striped table-bordered">
								 ...
								 foreach($komentar as $a){ ?>
                                    <tr>
										<td><?php echo $x++; ?></td>
										<td><?php echo $a->id_product; ?></td>
                                       <td style="text-transform: lowercase;"><?php echo $a->email; ?></td>
										<td><?php echo $a->isi; ?></td>
                                         <td><?php echo date('d-m-Y H:i:s', $a->date); ?></td>
                                       <td>
									   <a href="<?php echo site_url()."admin/hapus_komentar_produk/".$a->id; ?>" class="btn btn-danger btn-rounded">Hapus</a>

                           ...
                           <div class="row">
                              <div class="col-md-9">
                                 <div class="create-page-left">
                                     <?php echo form_open_multipart('admin/update_section', array(
    'enctype' => 'multipart/form-data'
)); ?>
					<form method="POST" autocomplete="off" id="nameform" enctype="multipart/form-data">
                                       <p>
                                          <label>Judul Section</label>
                                          <input type="text" placeholder="Masukan Judul Section" name="title" value="<?php echo $section[0]->title; ?>" required>
                                       </p>

                                       <div class="page-editor-box">
                                          <label>Konten</label>
                                          <textarea id="page-editor" name="konten" class="note-codable" required><?php echo $section[0]->konten; ?></textarea>
                                       </div>
									  
									    <div class="page-editor-box">
                                          <label>Video</label>
                                          <input type="text" placeholder="Masukan URL VIDEO YOUTUBE " name="video"  value="<?php echo $section[0]->video; ?>">
                                          <input type="hidden"  name="course_id" value="<?php echo $section[0]->id_course; ?>" required>
                                          <input type="hidden"  name="id" value="<?php echo $section[0]->id; ?>" required>
                                       </div>
                                       ...
                                       <p>
										   <input type="submit" value="perbarui produk" class="btn btn-warning" style="color:white;">
                                                <a href="<?php echo site_url(); ?>admin/daftar_section/<?php echo $section[0]->id_course; ?>" class="btn btn-danger" >

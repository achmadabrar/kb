                     ...
                     <div class="col-md-12">
                        <div class="page-box">
						 <div class="datatables-example-heading">
                               <a href="<?php echo site_url()."admin/tambah_slide/";?>" class="btn btn-warning btn-rounded">Tambah Slide</a>
                           </div>
                              ...
                              <table id="button_datatables_example" class="table display table-striped table-bordered">
								 ...
								 <?php foreach($slider as $a){ ?>
                                    <tr>
                                       ...
                                       <td>
									   <a href="<?php echo site_url()."admin/edit_slider/".$a->id; ?>" class="btn btn-warning btn-rounded">Edit</a>
									   <a href="<?php echo site_url()."admin/hapus_slider/".$a->id; ?>" class="btn btn-danger btn-rounded">Hapus</a>

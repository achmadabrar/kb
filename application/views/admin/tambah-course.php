                           ...
                           <div class="row">
                              <div class="col-md-9">
                                 <div class="create-page-left">
                                     <?php echo form_open_multipart('admin/insert_course', array(
    'enctype' => 'multipart/form-data'
)); ?>
					<form method="POST" autocomplete="off" id="nameform" enctype="multipart/form-data">
                                       <p>
                                          <label>Title Course</label>
                                          <input type="text" placeholder="Masukan Judul Course" name="title" required>
                                       </p>
									    <div class="row">
                                          <div class="col-md-6">
                                             <p>
									   ...
									   <br>
									    <div class="page-editor-box">
                                          ...
                                          <textarea id="page-editor" name="deskripsi" class="note-codable" required></textarea>
                                       </div>
									   <div class="row">
                                          <div class="col-md-6">
                                             <p>
									   ...
									   <br>
									    <div class="page-editor-box">
                                          ...
                                          <input type="text" placeholder="Masukan Durasi Contoh:2" name="durasi" required>
                                       </div>
									   ...
									   <br>
                                       <p>
										   <input type="submit" value="tambahkan course" class="btn btn-warning" style="color:white;">
